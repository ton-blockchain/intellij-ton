...
public class FuncDoUntilStatementImpl extends ASTWrapperPsiElement implements FuncDoUntilStatement {

  public FuncDoUntilStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
