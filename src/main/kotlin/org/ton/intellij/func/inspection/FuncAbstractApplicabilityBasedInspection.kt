...
abstract class FuncAbstractApplicabilityBasedInspection<TElement : FuncElement>(
    ...
    ): PsiElementVisitor = object : FuncVisitor() {
        override fun visitElement(o: FuncElement) {
    ...
    private class LocalFix<TElement : FuncElement>(
        @FileModifier.SafeFieldForPreview val inspection: FuncAbstractApplicabilityBasedInspection<TElement>,
