...
public class FuncIfNotStatementImpl extends ASTWrapperPsiElement implements FuncIfNotStatement {

  public FuncIfNotStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FuncVisitor visitor) {
    visitor.visitIfNotStatement(this);
  }
  ...
  @Override
  @NotNull
  public List<FuncBlock> getBlockList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, FuncBlock.class);
  }
