...
public class FuncTypedDeclarationListImpl extends ASTWrapperPsiElement implements FuncTypedDeclarationList {

  public FuncTypedDeclarationListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<FuncTypedDeclarationItem> getTypedDeclarationItemList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, FuncTypedDeclarationItem.class);
  }
