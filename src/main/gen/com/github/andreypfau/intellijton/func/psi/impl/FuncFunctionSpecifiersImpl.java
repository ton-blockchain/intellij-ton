...
public class FuncFunctionSpecifiersImpl extends ASTWrapperPsiElement implements FuncFunctionSpecifiers {

  public FuncFunctionSpecifiersImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FuncVisitor visitor) {
    visitor.visitFunctionSpecifiers(this);
  }
