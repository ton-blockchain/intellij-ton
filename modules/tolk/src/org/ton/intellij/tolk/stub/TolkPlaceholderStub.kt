...
open class TolkPlaceholderStub<PsiT : TolkElement>(parent: StubElement<*>, elementType: IStubElementType<*, *>) :
    ...
    open class Type<PsiT : TolkElement>(
        ...
        override fun createStub(psi: PsiT, parentStub: StubElement<out PsiElement?>): TolkPlaceholderStub<PsiT> =
            TolkPlaceholderStub(parentStub, this)

        override fun serialize(stub: TolkPlaceholderStub<PsiT>, dataStream: StubOutputStream) {
        }

        override fun deserialize(dataStream: StubInputStream, parentStub: StubElement<*>): TolkPlaceholderStub<PsiT> =
            TolkPlaceholderStub(parentStub, this)
    }
}
