...
public class FuncAssignmentExpressionImpl extends FuncExpressionImpl implements FuncAssignmentExpression {

  public FuncAssignmentExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
