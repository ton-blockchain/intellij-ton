...
public class FuncBlockImpl extends ASTWrapperPsiElement implements FuncBlock {

  public FuncBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public List<FuncStatement> getStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, FuncStatement.class);
  }
