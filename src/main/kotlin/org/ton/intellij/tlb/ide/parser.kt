...
class TlbParserDefinition : ParserDefinition {
    ...
    override fun getFileNodeType(): IFileElementType = TlbFileStub.Type
    override fun getCommentTokens(): TokenSet = COMMENTS
    override fun getStringLiteralElements(): TokenSet = TokenSet.EMPTY
    override fun createElement(node: ASTNode?): PsiElement = TlbElementTypes.Factory.createElement(node)
