...
abstract class TolkSelfTypeExpressionMixin :
    TolkStubbedElementImpl<TolkTypeStub<*>>,
    TolkSelfTypeExpression {
    ...
    class SelfTypeReference(element: TolkSelfTypeExpression) : PsiReferenceBase<TolkSelfTypeExpression>(element) {
        ...
        private inner class Resolver : ResolveCache.AbstractResolver<SelfTypeReference, TolkTypeExpression?> {
            override fun resolve(ref: SelfTypeReference, incompleteCode: Boolean): TolkTypeExpression? {
