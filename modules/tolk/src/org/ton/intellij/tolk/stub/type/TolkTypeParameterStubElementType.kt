...
class TolkTypeParameterStubElementType(debugName: String) :
    ...
    override fun createStub(psi: TolkTypeParameter, parentStub: StubElement<out PsiElement>): TolkTypeParameterStub =
        TolkTypeParameterStub(parentStub, this, psi.name)

    override fun createPsi(stub: TolkTypeParameterStub): TolkTypeParameter = TolkTypeParameterImpl(stub, this)
