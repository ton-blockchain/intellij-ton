...
public class FuncPlusMinExpressionImpl extends FuncExpressionImpl implements FuncPlusMinExpression {

  public FuncPlusMinExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
