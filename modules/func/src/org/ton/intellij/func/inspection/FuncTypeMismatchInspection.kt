...
class FuncTypeMismatchInspection : FuncInspectionBase() {
    override fun buildFuncVisitor(holder: ProblemsHolder, session: LocalInspectionToolSession): FuncVisitor =
        object : FuncVisitor() {
            ...
            override fun visitBinExpression(binExpression: FuncBinExpression) {
                ...
                } else if (left is FuncApplyExpression &&
                    left.left is FuncHoleTypeExpression &&
                    left.right is FuncTensorExpression
                ) {
    ...
    private class ChangeReturnTypeFix(function: FuncFunction, private val newTypeText: String) :
