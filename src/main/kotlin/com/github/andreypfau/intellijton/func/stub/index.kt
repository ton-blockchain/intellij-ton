...
class FuncNamedElementIndex : StringStubIndexExtension<FuncNamedElement>() {
    ...
    companion object {
        val KEY: StubIndexKey<String, FuncNamedElement> = StubIndexKey.createIndexKey(FuncNamedElementIndex::class.java.canonicalName)
    }
}
...
class FuncFunctionIndex : StringStubIndexExtension<FuncNamedElement>() {
    ...
    override fun getKey(): StubIndexKey<String, FuncNamedElement> = KEY
    companion object {
        val KEY: StubIndexKey<String, FuncNamedElement> = StubIndexKey.createIndexKey(FuncFunctionIndex::class.java.canonicalName)
    }
}