...
//        }
    ...
    private fun ProblemsHolder.check(function: TolkFunction, argument: TolkExpression, isMethodCall: Boolean) {
        ...
        val parameters = function.parameterList?.parameterList ?: emptyList()
    ...
    private fun ProblemsHolder.noValueForParameter(element: PsiElement, parameter: TolkParameter) {
