...
public class FuncInlineArrayExpressionImpl extends FuncExpressionImpl implements FuncInlineArrayExpression {

  public FuncInlineArrayExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
