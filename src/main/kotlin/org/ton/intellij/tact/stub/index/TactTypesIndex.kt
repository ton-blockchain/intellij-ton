...
class TactTypesIndex : StringStubIndexExtension<TactNamedElement>() {
    ...
    companion object {
        val KEY =
            StubIndexKey.createIndexKey<String, TactNamedElement>("org.ton.intellij.tact.stub.index.TactTypesIndex")
