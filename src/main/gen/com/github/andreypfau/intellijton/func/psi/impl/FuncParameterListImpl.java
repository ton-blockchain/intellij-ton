...
public class FuncParameterListImpl extends ASTWrapperPsiElement implements FuncParameterList {

  public FuncParameterListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<FuncParameterDef> getParameterDefList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, FuncParameterDef.class);
  }
