...
abstract class TolkCompletionTestBase : TolkTestBase() {
    ...
    protected fun doFirstCompletion(@Language("Tolk") before: String, @Language("Tolk") after: String) =
        completionFixture.doFirstCompletion(before, after)

    protected fun doSingleCompletion(@Language("Tolk") before: String, @Language("Tolk") after: String) =
    ...
    protected fun checkContainsCompletionPrefixes(prefixes: List<String>, @Language("Tolk") code: String) =
    ...
    fun checkEquals(@Language("Tolk") txt: String, count: Int, vararg variants: String) =
        completionFixture.doTestVariants(
            txt,
            CompletionType.BASIC,
            count,
            TolkCompletionTestFixtureBase.CheckType.EQUALS,
            *variants,
        )

    fun checkOrderedEquals(@Language("Tolk") txt: String, count: Int, vararg variants: String) =
        completionFixture.doTestVariants(
            txt,
            CompletionType.BASIC,
            count,
            TolkCompletionTestFixtureBase.CheckType.ORDERED_EQUALS,
            *variants,
        )
