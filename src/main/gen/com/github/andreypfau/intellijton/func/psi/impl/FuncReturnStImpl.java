...
public class FuncReturnStImpl extends ASTWrapperPsiElement implements FuncReturnSt {

  public FuncReturnStImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FuncVisitor visitor) {
    visitor.visitReturnSt(this);
  }
