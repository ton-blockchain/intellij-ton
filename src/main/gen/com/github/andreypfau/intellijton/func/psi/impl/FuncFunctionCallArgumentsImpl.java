...
public class FuncFunctionCallArgumentsImpl extends ASTWrapperPsiElement implements FuncFunctionCallArguments {

  public FuncFunctionCallArgumentsImpl(@NotNull ASTNode node) {
    super(node);
  }
