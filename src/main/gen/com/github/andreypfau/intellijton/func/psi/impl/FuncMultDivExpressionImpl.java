...
public class FuncMultDivExpressionImpl extends FuncExpressionImpl implements FuncMultDivExpression {

  public FuncMultDivExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
