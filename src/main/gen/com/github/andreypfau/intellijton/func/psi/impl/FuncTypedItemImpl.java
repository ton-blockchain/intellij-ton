...
public class FuncTypedItemImpl extends ASTWrapperPsiElement implements FuncTypedItem {

  public FuncTypedItemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FuncVisitor visitor) {
    visitor.visitTypedItem(this);
  }
