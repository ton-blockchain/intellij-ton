...
public class FuncIndexAccessExpressionImpl extends FuncExpressionImpl implements FuncIndexAccessExpression {

  public FuncIndexAccessExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
