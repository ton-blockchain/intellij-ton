...
/**
 * Almost standard JUnit 4 test runner (see [org.junit.runners.BlockJUnit4ClassRunner]), but unlike the standard one
 ...
 */
class TolkJUnit4TestRunner(testClass: Class<*>) : BlockJUnit4ClassRunner(testClass) {
