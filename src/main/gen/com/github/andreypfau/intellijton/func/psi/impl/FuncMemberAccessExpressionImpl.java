...
public class FuncMemberAccessExpressionImpl extends FuncExpressionImpl implements FuncMemberAccessExpression {

  public FuncMemberAccessExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
