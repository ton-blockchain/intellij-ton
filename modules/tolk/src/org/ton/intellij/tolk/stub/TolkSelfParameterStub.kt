...
class TolkSelfParameterStub(parent: StubElement<*>?, elementType: IStubElementType<*, *>, val isMutable: Boolean) :
    ...
    object Type : TolkStubElementType<TolkSelfParameterStub, TolkSelfParameter>(
        ...
        override fun createStub(psi: TolkSelfParameter, parentStub: StubElement<out PsiElement?>?) =
            TolkSelfParameterStub(parentStub, this, psi.isMutable)

        override fun serialize(stub: TolkSelfParameterStub, dataStream: StubOutputStream) {
            dataStream.writeBoolean(stub.isMutable)
        }

        override fun deserialize(dataStream: StubInputStream, parentStub: StubElement<*>?): TolkSelfParameterStub {
