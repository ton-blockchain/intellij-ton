...
class TolkCoverageAnnotator(project: Project) : SimpleCoverageAnnotator(project) {
    ...
    override fun getLinesCoverageInformationString(info: FileCoverageInfo): String? = when {
    ...
    override fun getFilesCoverageInformationString(info: DirCoverageInfo): String? = when {
        info.totalFilesCount == 0 -> null
        info.coveredFilesCount == 0 -> TolkBundle.message(
            "0.of.1.files.covered",
