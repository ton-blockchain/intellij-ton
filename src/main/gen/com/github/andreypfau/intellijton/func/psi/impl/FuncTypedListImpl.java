...
public class FuncTypedListImpl extends ASTWrapperPsiElement implements FuncTypedList {

  public FuncTypedListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FuncVisitor visitor) {
    visitor.visitTypedList(this);
  }
  ...
  @Override
  @NotNull
  public List<FuncTypedItem> getTypedItemList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, FuncTypedItem.class);
  }
