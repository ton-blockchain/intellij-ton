...
public class FuncModifierAccessExpressionImpl extends FuncExpressionImpl implements FuncModifierAccessExpression {

  public FuncModifierAccessExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull FuncVisitor visitor) {
    visitor.visitModifierAccessExpression(this);
  }
