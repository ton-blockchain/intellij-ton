...
class TolkFormattingBlock(
    ...
    private fun createBlock(node: ASTNode): ASTBlock? {
        ...
        val childIndent =
            when (node.elementType) {
                ...
                FUNCTION, STRUCT, ENUM, GLOBAL_VAR, CONST_VAR -> Indent.getNoneIndent()
    ...
    private fun calcIndent(child: ASTNode): Indent? {
        ...
        when (parentType) {
            ...
            PARAMETER_LIST, BLOCK_STATEMENT, STRUCT_EXPRESSION_BODY, STRUCT_BODY, ENUM_BODY -> return indentIfNotBrace(child)
